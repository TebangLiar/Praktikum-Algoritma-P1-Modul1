...
void tambahDepanHT() {
    ...
    cout<<"Data \""<<dataBaru<<"\" berhasil dimasukan di bagian depan.";
}
...
void hapusDepanH() {
    ...
    } else cout<<"Tidak ada data pada Linked List"<<endl;
}
...
void hapusBelakangH() {
    ...
    if(isEmptyH() == 0) {
        ...
        delete hapus;
        cout<<"Data \""<<data<<"\" berhasil dihapus dari bagian belakang."<<endl;
    } else cout<<"Tidak ada data pada Linked List"<<endl;
}
